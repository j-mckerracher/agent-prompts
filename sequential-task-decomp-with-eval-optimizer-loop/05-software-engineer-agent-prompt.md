...
3. **Test Execution**: Run Jest tests and ensure they pass
...
4. **Verify**: Run Jest tests for affected scope
...
1. Run Jest for affected test files
2. Run Jest for integration tests if applicable
