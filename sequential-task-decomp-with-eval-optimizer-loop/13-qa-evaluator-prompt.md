...
|------|---------------|----------------|
| Jest full suite | `npm test` | Exit code 0, 100% pass rate |
| Cypress full suite | `npx cypress run` | Exit code 0, 100% pass rate |
...
2. If Jest full suite fails → **FAIL** immediately
3. If Cypress full suite fails → **FAIL** immediately
