...
**Your #1 responsibility**: Compare any new or modified UI element against pre-existing, unchanged instances of the same element type. If the implementation introduces inconsistencies with established patterns, this is a failure.
...
- `planning/uow_plan.yaml`: Units of work (to identify UI-related UoWs)
