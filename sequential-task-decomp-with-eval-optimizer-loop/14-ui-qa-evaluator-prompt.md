...
| Fail | Baseline elements are not comparable or missing entirely |
...
3. If new pattern is justified, evaluate against design guidelines
4. Note this as a new pattern for future baselines
