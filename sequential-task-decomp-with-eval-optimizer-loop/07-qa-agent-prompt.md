...
- `planning/tasks.yaml`, `planning/uow_plan.yaml`, etc.: All intermediate artifacts for traceability
...
1. **Jest**: Full test suite must pass
2. **Cypress**: Full test suite must pass
...
1. **Automated tests**: Reference passing Jest/Cypress tests
