...
This is a dedicated Cypress (or similar) E2E test project. All integration tests you write go here, NOT in the main application codebase. For greenfield, if the E2E app does not exist, scaffold it as a setup UoW or document a blocked status.
...
1. **Query Reference Librarian FIRST**: Ask for E2E testing standards and existing patterns (or greenfield defaults)
...
log_type: "integration_test_writer"
  ...
  e2e_app_path: "{{e2e_tests_root}}"
  session_summary: {
    input_artifacts_read: ["execution/UOW-001/impl_report.yaml", "planning/Work-Decomposer-Output.md"]
